...
cd C:\Users\sp_tamatsu\Documents\MATLAB\program\rule_learning
%name: task_miceid
...
cd C:\Users\sp_tamatsu\Documents\MATLAB\edit_data\Injury\Control\moved_only\ %data file path
...
porking = NaN(1,15); %正しい報酬の位置でポーキングした割合
laps = NaN(1,15); %周回数
CR = NaN(1,15); %正答率
pCR = NaN(1,15); %完答率
%ここにコード追加
cd C:\Users\sp_tamatsu\Documents\MATLAB\function
for ii=1:n
...
%save
cd C:\Users\sp_tamatsu\Documents\MATLAB\analysis\behavior\injury\Control\moved_only\
save(savename)
