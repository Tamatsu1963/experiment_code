function [CL_rule1, CL_rule2, CL_rule3, CL_rule4, CL_rule5] = f_Chance_Level_rule(load_path,name)
    cd (load_path)
    cd all\
    foldername1 = "Day1";
    foldername2 = "Day2";
    ...
    d4_rule=zeros(1,n4);
    d5_rule=zeros(1,n5);
    CL_rule1 = zeros(1,1000);
    CL_rule2 = zeros(1,1000);
    CL_rule3 = zeros(1,1000);
    CL_rule4 = zeros(1,1000);
    CL_rule5 = zeros(1,1000);
    for ss=1:1000
        for i1=1:n1
        ...
        CL_rule1(1,ss) = sum(d1_rule,2)/n1;
        CL_rule2(1,ss) = sum(d2_rule,2)/n2;
        CL_rule3(1,ss) = sum(d3_rule,2)/n3;
        CL_rule4(1,ss) = sum(d4_rule,2)/n4;
        CL_rule5(1,ss) = sum(d5_rule,2)/n5;
    end
